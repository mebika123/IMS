...
const SellOrders = () => {
    ...
    const updateStatus = async (orderId, status) => {
        try {
            const res = await axios.put(`/saleOrders/{id}/status/{status}`);
            ...
            {loading ? (
                ...
                <div className="shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] bg-white border border-[#E5E7EB] rounded-sm p-3 w-full mb-4">
                    <div className="flex justify-between items-center">
                        ...
                        <Link className='rounded-lg bg-darkgreen text-white py-2 px-5' to='/dashboard/sale/order/request'>+ New Order Request</Link>
                    </div>
                    <div className="mt-5">
